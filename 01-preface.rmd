...
R less frustrating. To download RStudio, go to the bottom of  https://www.rstudio.com/products/rstudio/download/#download and select the correct version under
...
With a data set converted to a CSV file, we need to read the data set into the active workspace. There
...
``treadmill <- read_csv("http://www.math.montana.edu/courses/s217/documents/treadmill.csv", header=T)``.] 
