...
knitr::include_graphics('chapter0_files/image002.png')
```
...
knitr::include_graphics('chapter0_files/fig1.2.png')
```
...
```{r include=F}
treadmill <- read_csv("chapter0_files/treadmill.csv")
```
...
knitr::include_graphics('chapter0_files/fig1.3.png')
```
...
knitr::include_graphics('chapter0_files/fig1.4.png')
```
...
```{r Figure5, fig.cap='(ref:fig5)',echo=F}
...
```{r Figure6,echo=FALSE,fig.cap="(ref:fig6)",fig.width=6,fig.height=3.5}
...
```{r Figure7, fig.cap="(ref:fig7)",echo=F,fig.width=4,fig.height=2.75}
hist(treadmill$RunTime, labels=T)
```
...
```{r Figure8, fig.cap="(ref:fig8)",echo=F,fig.width=4,fig.height=2.5}
old.par <- par(mai=c(0.5,0.5,0.5,0.5))
...
```{r Figure9, fig.cap="(ref:fig9)",echo=F,fig.width=4,fig.height=2.5}
