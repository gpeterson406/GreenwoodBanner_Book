...
library(knitr)
<<<<<<< HEAD
knitr::opts_chunk$set(cache=T,fig.width = 5, fig.height = 3.5,
                      fig.pos = "HT", message=F,warning=F)
=======
knitr::opts_chunk$set(echo = TRUE,cache=T,fig.width = 5, fig.height = 3.5,
                      fig.pos = "HT")
...
```{r Figure7, fig.cap="(ref:fig7)",fig.width=4,fig.height=2.75}
