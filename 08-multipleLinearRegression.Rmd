...
\indent  **VIFs** provide a way to assess the multicollinearity in the MLR model that
...
any slope coefficients from this model because they all being impacted by shared information in the predictor variables. 
...
res1<-as.data.frame(Treatment=Headache$treatment,dummies)[1:17,]
#res1
...
\indent Sometimes researchers are specifically interested in whether the slopes vary
...
\indent Or we can let the term-plots (Figures \@ref(fig:Figure8-31) and 
