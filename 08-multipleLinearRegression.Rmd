...
= `r colFmt("X1_NEW","red")`, `r colFmt("x2","red")` = `r colFmt("X2_NEW","red")`, 
`r colFmt("...","red")`, `r colFmt("xK","red")` = `r colFmt("XK_NEW","red")`, 
interval="confidence")
...
* AIC(`r colFmt("MODELNAME_1","red")`, `r colFmt("MODELNAME_2","red")`)

    * Use to get AIC results for two candidate models called ``MODELNAME_1``
    and ``MODELNAME_2``.
    
* options(na.action = "na.fail")  
dredge(`r colFmt("FULL_MODELNAME","red")`, rank="AIC", extra=c("R^2", 
