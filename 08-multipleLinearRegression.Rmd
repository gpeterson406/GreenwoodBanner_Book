...
\indent In many situations, especially in observational studies, it is unlikely that
...
+0.984\cdot\text{MinTemp}_i +1.243\cot\text{MaxTemp}_i$$
...
interpretations. They can help us the model predicts over the range of each 
observed $x$. This can
...
\indent The top model with *Elevation* and *Max.Temp* has an ***R***^2^ of
