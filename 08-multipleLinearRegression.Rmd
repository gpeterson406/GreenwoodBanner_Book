...
```{r Figure8-4,fig.cap="(ref:fig8-4)",fig.width=3.5,fig.height=3}
...
* **Multicollinearity in MLR models:**
    ...
    ```{r Figure8-12,fig.cap="(ref:fig8-12)",message=F,warning=F}
    require(corrplot)
...
```{r Figure8-21,fig.cap="(ref:fig8-21)",warning=F,message=F}
require(heplots)
data(Headache)
...
```{r Figure8-24,fig.cap="(ref:fig8-24)",warning=F,message=F}
par(mfrow=c(2,2), oma=c(0,0,2,0))
...
```{r Figure8-26,fig.cap="(ref:fig8-26)",warning=F,message=F}
par(mfrow=c(2,2), oma=c(0,0,2,0))
plot(dys_model,
...
```{r Figure8-31,fig.cap="(ref:fig8-31)",warning=F,message=F}
...
```{r Figure8-32,fig.cap="(ref:fig8-32)",warning=F,message=F}
...
knitr::include_graphics("chapter8_files/image299.png")
```
