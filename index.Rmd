...
knitr::include_graphics('frontMatter/titlepage_2017.jpg')
}
```
...
```{r include=FALSE}
knitr::write_bib(c(
  .packages(), "readr", "knitr", "tibble","mosaic","heplots", "beanplot", "spuRs",
