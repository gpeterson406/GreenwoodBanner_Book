...
<!--chapter:end:02-reintroductionToStatistics.rmd-->
...
<!--chapter:end:03-oneWayAnova.rmd-->
...
<!--chapter:end:04-twoWayAnova.rmd-->
...
<!--chapter:end:05-chiSquaredTests.rmd-->
...
@Gude2009 explored the relationship 
...
![(\#fig:Figure6-14)(ref:fig6-14)](chapter6_files/image047.png) 
...
[@R-tigerstats] and ``manipulate`` [@R-manipulate] packages in R-studio 
...
![(\#fig:Figure6-17)(ref:fig6-17)](chapter6_files/image063.png) 
...
<!--chapter:end:06-correlationAndSimpleLinearRegression.rmd-->
...
![(\#fig:Figure7-3)(ref:fig7-3)](chapter7_files/image034.png) 
...
![(\#fig:Figure7-4)(ref:fig7-4)](07-simpleLinearRegressionInference_files/figure-latex/Figure7-4-1.pdf) 
...
different response variables or both, in one study. @Moore2007
...
not accounting for the number of tests performed**^[The simplest adjustment for 
...
(@R-car, @Fox2003) in a data set called ``UN``. The four panels in 
...
nomenclature was adopted from @DeVeaux2001 *Stats: Data and
...
* \textcolor{red}{DATASETNAME\$logy} <- log(\textcolor{red}{DATASETNAME\$y})
...
<!--chapter:end:07-simpleLinearRegressionInference.rmd-->
...
name the method after himself in the original paper that proposed it.], 
...
<!--chapter:end:08-multipleLinearRegression.rmd-->
...
<!--chapter:end:09-caseStudies.rmd-->
