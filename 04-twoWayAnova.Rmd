...
```{r Table4-3,echo=F}
require(pander)
columnHeaders <- c("$\\color{red}{\\text{Cig}\\\\\\text{Buy}}$",
                   "$\\color{blue}{\\textbf{Income}\\\\\\textbf{Group 1}}$",
                   "$\\color{blue}{\\textbf{Income}\\\\\\textbf{Group 2}}$",
                   "$\\color{blue}{\\textbf{Income}\\\\\\textbf{Group 3}}$",
                   "$\\color{blue}{\\textbf{Income}\\\\\\textbf{Group 4}}$", 
                   "$\\color{blue}{\\textbf{Income}\\\\\\textbf{Group 5}}$")
row1 <- c("$\\color{red}{\\text{0:}\\\\\\text{No}}$","$\\hat{\\alpha} \\\\=\\small{3.055}$",
          "$\\hat{\\alpha} + \\hat{\\tau}_2 \\\\=\\small{3.055 + 0.016} \\\\= \\small{3.071}$",
          "$\\hat{\\alpha} + \\hat{\\tau}_3 \\\\=\\small{3.055 + 0.175} \\\\= \\small{3.230}$",
          "$\\hat{\\alpha} + \\hat{\\tau}_4 \\\\=\\small{3.055 + 0.169} \\\\= \\small{3.224}$",
          "$\\hat{\\alpha} + \\hat{\\tau}_5 \\\\=\\small{3.055 + 0.468} \\\\= \\small{3.523}$"
          )
row2 <- c("$\\color{red}{\\text{1:}\\\\\\text{Yes}}$",
          "$\\hat{\\alpha}+\\hat{\\gamma}_2\\\\=\\small{3.055}\\\\\\small{-0.106}\\\\=\\small{2.949}$",
          "$\\hat{\\alpha}+\\hat{\\tau}_2+\\hat{\\gamma}_2\\\\=\\small{3.055+0.016}\\\\\\small{-0.106}\\\\=\\small{2.965}$",
          "$\\hat{\\alpha}+\\hat{\\tau}_3+\\hat{\\gamma}_2\\\\=\\small{3.055+0.175}\\\\\\small{-0.106}\\\\=\\small{3.124}$",
          "$\\hat{\\alpha}+\\hat{\\tau}_4+\\hat{\\gamma}_2\\\\=\\small{3.055+0.169}\\\\\\small{-0.106}\\\\=\\small{3.118}$",
          "$\\hat{\\alpha}+\\hat{\\tau}_5+\\hat{\\gamma}_2\\\\=\\small{3.055+0.468}\\\\\\small{-0.106}\\\\=\\small{3.417}$")
t <- matrix(c(row1,row2),ncol = 6,byrow=T,dimnames = list(c("",""),columnHeaders))
kable(t,caption="(ref:tab4-3)")
```
...
```{r Figure4-17,fig.cap="(ref:fig4-17)",warning=F,message=FALSE}
par(mfrow=c(1,1))
...
```{r Figure4-18,fig.cap="(ref:fig4-18)",message=F,warning=F}
