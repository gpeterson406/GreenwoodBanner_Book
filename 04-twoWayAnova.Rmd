...
```{r Figure4-2,fig.cap="(ref:fig4-2)",echo=F}
intplot(responses ~ brand*drops, data=pt,cex.main=1,cex.leg=0.75,xleg=25)
```
...
```{r Figure4-3, fig.cap="(ref:fig4-3)",echo=F}
intplot(responses ~ drops*brand, data=pt,cex.main=1,cex.leg=0.75,xleg=2.5)
```
...
2. **Validity conditions:**
    ...
    * Constant variance:
        ...
        * In the Residuals vs Fitted and the Scale-Location plots, the 
        ...
        ```{r Figure4-9,fig.cap="Diagnostic plots for the interaction model for Tooth         Growth.",echo=F,fig.height=4,fig.width=6}
        par(mfrow=c(2,2))
        old.par <- par(mai=c(0.75,0.75,0.5,0.5))
...
```{r Figure4-11,fig.cap="(ref:fig4-11)",echo=F,fig.pos="HB!"}
par(mfrow=c(1,1))
...
```{r Figure4-12,fig.cap="(ref:fig4-12)",echo=F,fig.height=3.75}
intplot(prodebt ~ cigbuy*incomegp, data=debtc, col=c(1,3), lwd=2,cex.main=1,
        cex.lab=0.75,xlim=c(0.5,6.5),x.leg=5.5)
```
...
```{r Figure4-13,fig.cap="(ref:fig4-13)",echo=F,fig.height=3.75,fig.width=6}
par(mfrow=c(2,2))
old.par <- par(mai=c(0.75,0.75,0.3,0.25))
...
2. **Validity conditions -- discussed above but with new plots for the additive:**
    ...
    ```{r Figure4-14,fig.cap="Diagnostic plot for ``prodebt`` by income group and buy   cigarettes/not",echo=F,fig.height=3.75,fig.width=6}
