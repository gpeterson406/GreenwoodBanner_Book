...
```{r Table4-3,echo=F}
columnHeaders <- c("$\\color{red}{\\text{Cig Buy}}$",
                   "$\\color{blue}{\\textbf{Income Group 1}}$",
                   "$\\color{blue}{\\textbf{Income Group 2}}$",
                   "$\\color{blue}{\\textbf{Income Group 3}}$",
                   "$\\color{blue}{\\textbf{Income Group 4}}$",
                   "$\\color{blue}{\\textbf{Income Group 5}}$")
row1 <- c("$\\color{red}{\\text{0:}\\text{No}}$",
...
row2 <- c("$\\color{red}{\\text{1:}\\text{Yes}}$",
          "$\\hat{\\alpha}+\\hat{\\gamma}_2={\\small 3.055 -0.106=2.949}$",
          ...
          "$\\hat{\\alpha}+\\hat{\\tau}_5+\\hat{\\gamma}_2={\\small 3.055+0.468 -0.106} ={\\small 3.417}$")
t <- matrix(c(row1,row2),ncol = 6,byrow=T)
kable(t,caption="(ref:tab4-3)",col.names = columnHeaders,escape=F, longtable=T, booktabs=T)
```
