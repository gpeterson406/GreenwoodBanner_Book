...
\indent The requirements for a One-Way ANOVA $F$-test are similar to those discussed in 
...
for all observations. Like in hypothesis testing, you can't prove that you can never prove that you've 
...
as they will just be a little conservative. For any of the patterns, you would not a potential violation of the normality assumption and then proceed to describe the type of violation and how clear or extreme it seems to be.
...
can assume the observations are independent^[A violation of the independence assumption could have easily been created if they measured cells in two locations on each guinea pig or took measurements over time on each one.]. We need to create a variable that
...
2. **Validity conditions**:
    ...
    * Constant variance:
        ...
        * As noted above, there is some indication of a difference in the 
        ...
        ```{r Figure3-15,fig.cap="Diagnostic plots for the odontoblast growth model.",fig.height=5,fig.width=8}
        ...
        * Put together, the evidence for non-constant variance is not that strong and we can
        proceed comfortable that there is at least not a major problem with this assumption. 
...
\indent With evidence that the true means are likely not all equal, many researchers 
...
\indent In our previous work with the prisoner rating data, the overall ANOVA test
