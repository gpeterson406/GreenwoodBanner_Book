...
```{r Figure3-1,fig.cap="(ref:fig3-1)"}
require(heplots)
require(mosaic)
data(MockJury)
par(mfrow=c(1,2))
...
```{r Figure3-19, fig.cap="(ref:fig3-19)", fig.height=55,fig.width=10}
require(multcomp)
...
```{r Figure3-20, fig.cap="(ref:fig3-20)",echo=F,fig.width=10,fig.height=5}
