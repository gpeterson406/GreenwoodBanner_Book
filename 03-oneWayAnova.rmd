...
require(mosaic)
library(knitr)
knitr::opts_chunk$set(cache = TRUE,fig.height=4,fig.width=6,fig.pos='HT')
...
kable(x,col.names=columnHeaders,caption='(ref:tab3-1)',escape=F)
```
...
kable(x,col.names=columnHeaders,caption='(ref:tab3-2)',escape=F)
```
