...
```{r Figure3-7,fig.cap="(ref:fig3-7)",echo=F}
par(mfrow=c(1,2),ps=8)
hist(Tstar, labels=T)
abline(v=Tobs, col="red", lwd=3)
plot(density(Tstar), main="Density curve of Tstar")
abline(v=Tobs, col="red", lwd=3)
...
```{r Figure3-9,fig.cap="(ref:fig3-9)",echo=F,fig.width=6,fig.asp=0.75}
par(mfrow=c(2,2))
plot(lm2,pch=16)
```
...
```{r Figure3-10, fig.cap="(ref:fig3-10)",fig.height=3}
par(mfrow=c(1,2))
eij<-residuals(lm2)
...
2. **Validity conditions**:
    ...
    * Constant variance:
        ...
        * As noted above, there is some indication of a difference in the 
        ...
        ```{r Figure3-15,fig.cap="Diagnostic plots for the toothgrowth model.",fig.height=4,fig.width=6.5}
...
```{r Figure3-17, fig.cap="(ref:fig3-17)",fig.height=3,fig.width=4}
...
```{r Figure3-19, fig.cap="(ref:fig3-19)", fig.height=4}
par(mfrow=c(1,1))
require(multcomp)
...
```{r Figure3-20, fig.cap="(ref:fig3-20)",echo=F,fig.width=5.5,fig.asp=0.75}
old.par <- par(mai=c(1,1,1,1))
beanplot(len~Treat,data=ToothGrowth,log="",col="white",method="jitter")
text(c(2),c(10),"a",col="blue",cex=1.5)
text(c(3,5,6),c(25,28,28),"b",col="green",cex=1.5)
text(c(1,4),c(15,18),"c",col="red",cex=1.5)
```
...
```{r Figure3-21,fig.cap="(ref:fig3-21)",fig.height=4}
lm2<-lm(Years~Attr, data=MockJury)
require(multcomp)
