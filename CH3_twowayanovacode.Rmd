...
par(mfrow=c(1,2))
intplot(jitter(fitted(debt1r))~cigbuy*incomegp,data=debtc,col=c(1,3),lwd=2,main="(a)",ylab="Mean of ProDebt")
intplot(jitter(fitted(debt1r))~incomegp*cigbuy,data=debtc,lwd=2,main="(b)",ylab="Mean of ProDebt")
...
#Randomized block analysis: To be added to Version 4
