...
there are so many variables, there will be information on some other variables that were not displayed at the bottom of the results of the ``head`` or ``tail`` results. 
