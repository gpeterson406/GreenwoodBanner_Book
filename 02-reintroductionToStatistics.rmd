...
```{r Figure2-9, fig.cap="(ref:fig2-9)",echo=F,fig.width=6,cache=F}
par(mfrow=c(1,2))
B <- 1000
Tstar <- matrix(NA, nrow=B)
for (b in (1:B)){
...
hist(Tstar, label=T,ylim=c(0,250),cex.lab=0.75)
plot(density(Tstar), main="Density curve of Tstar",cex.lab=0.75)
```
...
<<<<<<< HEAD
```{r Figure2-10, fig.cap="(ref:fig2-10)",echo=F,fig.width=6,cache=T}
par(mfrow=c(1,2))
Tobs <- 1.837
hist(Tstar, labels=T,ylim=c(0,250),cex.lab=0.75)
...
```{r eval=F}
=======
```{r Figure2-10, fig.cap="(ref:fig2-10)"}
>>>>>>> origin/chapter0to1_edits
par(mfrow=c(1,2))
Tobs <- 1.837
hist(Tstar, labels=T)
...
```{r Figure2-11, fig.cap="(ref:fig2-11)",echo=F,fig.width=6,cache=T}
par(mfrow=c(1,2))
hist(Tstar, labels=T,ylim=c(0,250),cex.lab=0.75)
...
```{r Figure2-12, fig.cap="(ref:fig2-12)"}
>>>>>>> origin/chapter0to1_edits
par(mfrow=c(1,2))
...
```{r Figure2-12, fig.cap="(ref:fig2-12)",echo=F,fig.width=6,cache=T}
par(mfrow=c(1,2))
hist(Tstar, labels=T,ylim=c(0,250),cex.lab=0.75)
abline(v=c(-1,1)*Tobs, lwd=2, col="red")
plot(density(Tstar), main="Density curve of Tstar",cex.lab=0.75)
...
knitr::include_graphics('chapter1_files/image045small.png')
```
...
knitr::include_graphics('chapter1_files/image047small.png')
```
...
```{r Figure2-16, fig.cap="(ref:fig2-16)",echo=F,fig.width=6,cache=T}
par(mfrow=c(1,2))
hist(Tstar,labels=T,ylim=c(0,225),cex.lab=0.75)
abline(v=c(-1,1)*Tobs, lwd=2, col="red")
plot(density(Tstar), main="Density curve of Tstar",cex.lab=0.75)
abline(v=c(-1,1)*Tobs, lwd=2, col="red")
```
...
```{r Figure2-18, fig.cap="(ref:fig2-18)",echo=F,fig.width=6,cache=T}
par(mfrow=c(1,2))
hist(Tstar, labels=T,ylim=c(0,225),cex.lab=0.75)
...
```{r Figure2-19, fig.cap="(ref:fig2-19)",echo=F,fig.width=6,cache=T}
par(mfrow=c(1,2))
hist(Tstar, labels=T,ylim=c(0,225),cex.lab=0.75)
...
<<<<<<< HEAD
```{r Figure2-20,fig.cap="(ref:fig2-20)",cache=T}
=======
...
```{r Figure2-21,fig.cap="(ref:fig2-21)",echo=F,fig.width=6,cache=T}
par(mfrow=c(1,2))
hist(Tstar,labels=T,ylim=c(0,225),cex.lab=0.75)
abline(v=Tobs,col="red",lwd=2)
