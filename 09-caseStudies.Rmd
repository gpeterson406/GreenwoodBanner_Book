...
```{r Figure9-10,fig.cap="(ref:fig9-10)",echo=F,fig.height=5,fig.width=10}
...
this model further but we should checked the diagnostics (Figure \@ref(fig:Figure9-11)) and consider our model
