...
```{r Figure5-1,fig.cap="(ref:fig5-1)"}
require(vcd)
...
col1 <- c("**Group 1**","**Group 2**","**...**","**Group R**","**Totals**")
col2 <- c("$\\rho_{11}$","$\\rho_{21}$","...","$\\rho_{R1}$",
          "$\\boldsymbol{\\rho_{\\bullet 1}}$")
col3 <- c("$\\rho_{12}$","$\\rho_{22}$","...","$\\rho_{R2}$",
          "$\\boldsymbol{n_{\\bullet 2}}$")
col4 <- c("$\\rho_{13}$","$\\rho_{23}$","...","$\\rho_{R3}$",
          "$\\boldsymbol{\\rho_{\\bullet 3}}$")
col5 <- c("...","...","...","...","...")
col6 <- c("$\\rho_{1C}$","$\\rho_{2C}$","...","$\\rho_{RC}$",
          "$\\boldsymbol{\\rho_{\\bullet C}}$")
