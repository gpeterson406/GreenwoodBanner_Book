...
\indent In Chapter \@ref(chapter6), we learned how to estimate and interpret 
...
\indent Figure \@ref(fig:Figure7-2) contains simulated realizations from a normal
...
\indent This variability due to random sampling is something that needs to be
...
\indent So be careful to think about the domain of the transformation function 
