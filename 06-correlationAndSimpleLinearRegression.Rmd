...
```{r Figure6-10,fig.cap="(ref:fig6-10)",fig.width=5,fig.height=3.5}
...
```{r Figure6-12,fig.cap="(ref:fig6-12)",echo=F,fig.height=7,fig.width=7}
...
```{r Figure6-13,fig.cap="(ref:fig6-13)",echo=F}
