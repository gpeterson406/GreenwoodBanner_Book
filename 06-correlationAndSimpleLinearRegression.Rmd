...
```{r Figure6-13,fig.cap="(ref:fig6-13)",warning=F,message=F}
...
```{r Figure6-16,fig.cap="(ref:fig6-16)",echo=F,warning=F,message=F}
...
plot(s1,ss1,type="l",col="blue",lwd=2,xlab="Possible Slope Coefficients",
     ...
     main="Sums of squared residuals for different Slopes (Beers vs BAC data)")
...
```{r Figure6-19,fig.cap="(ref:fig6-19)",echo=F,message=F,warning=F}
m1<-lm(BAC~Beers,data=BB)
...
* **Beers vs BAC:**
    ...
    * Independence of observations:
        ...
        *BAC* data.
        ...
        ```{r Figure6-22,fig.cap="(ref:fig6-22)",warning=F,message=F,fig.height=5,fig.width=8}
        m1 <- lm(BAC~Beers, data=BB)
        par(mfrow=c(2,2))
...
```{r Figure6-23,fig.cap="(ref:fig6-23)",message=F,warning=F}
...
```{r Figure6-24,fig.cap="(ref:fig6-24)",warning=F,message=F,fig.height=5,fig.width=8}
require(MASS)
data(geyser)
...
```{r Figure6-25,fig.cap="(ref:fig6-25)",message=F,warning=F,fig.height=5,fig.width=8}
